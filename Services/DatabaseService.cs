    ...
    public class DatabaseService
    {
        ...
        public static async Task InitAsync(string dbPath)
        {
            ...
            if (isFirstRun)
            {
                ...
                {
                    new() { Titulo = "The Hobbit", Autor = "J.R.R. Tolkien", Genero = "Fantasia", ISBN = "1234567890", Anio = 1937, Descripcion = "Un viaje inesperado.", Imagen = "https://images-na.ssl-images-amazon.com/images/I/712cDO7d73L.jpg" },
                    new() { Titulo = "1984", Autor = "George Orwell", Genero = "Ficcion", ISBN = "1234567891", Anio = 1949, Descripcion = "Distopía totalitaria.", Imagen = "https://images-na.ssl-images-amazon.com/images/I/71kxa1-0mfL.jpg" },
                    new() { Titulo = "To Kill a Mockingbird", Autor = "Harper Lee", Genero = "Ficcion", ISBN = "1234567892", Anio = 1960, Descripcion = "Justicia y racismo.", Imagen = "https://images-na.ssl-images-amazon.com/images/I/71FxgtFKcQL.jpg" },
                    new() { Titulo = "Dune", Autor = "Frank Herbert", Genero = "Ciencia ficcion", ISBN = "1234567893", Anio = 1965, Descripcion = "Planeta desértico y poder.", Imagen = "https://images-na.ssl-images-amazon.com/images/I/81zN7udGRUL.jpg" },
                    new() { Titulo = "Pride and Prejudice", Autor = "Jane Austen", Genero = "Romance", ISBN = "1234567894", Anio = 1813, Descripcion = "Orgullo, prejuicio y amor.", Imagen = "https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1681804503i/129915654.jpg" },
                    new() { Titulo = "The Great Gatsby", Autor = "F. Scott Fitzgerald", Genero = "Ficcion", ISBN = "1234567895", Anio = 1925, Descripcion = "El sueño americano.", Imagen = "https://images-na.ssl-images-amazon.com/images/I/81af+MCATTL.jpg" },
                    new() { Titulo = "Harry Potter y la Piedra Filosofal", Autor = "J.K. Rowling", Genero = "Fantasia", ISBN = "1234567896", Anio = 1997, Descripcion = "Magia en Hogwarts.", Imagen = "https://images-na.ssl-images-amazon.com/images/I/81YOuOGFCJL.jpg" },
                    new() { Titulo = "El nombre del viento", Autor = "Patrick Rothfuss", Genero = "Fantasia", ISBN = "1234567897", Anio = 2007, Descripcion = "La historia de Kvothe.", Imagen = "https://images-na.ssl-images-amazon.com/images/I/91dSMhdIzTL.jpg" },
                    new() { Titulo = "Fahrenheit 451", Autor = "Ray Bradbury", Genero = "Ciencia ficcion", ISBN = "1234567898", Anio = 1953, Descripcion = "Libros prohibidos.", Imagen = "https://images-na.ssl-images-amazon.com/images/I/71OFqSRFDgL.jpg" },
                    new() { Titulo = "Crónica de una muerte anunciada", Autor = "Gabriel García Márquez", Genero = "Ficcion", ISBN = "1234567899", Anio = 1981, Descripcion = "Tragedia anunciada.", Imagen = "https://m.media-amazon.com/images/I/91geyJSGR6L.jpg" },
                    new() { Titulo = "Don Quijote de la Mancha", Autor = "Miguel de Cervantes", Genero = "Clasico", ISBN = "1234567810", Anio = 1605, Descripcion = "Caballería y locura.", Imagen = "https://images-na.ssl-images-amazon.com/images/I/71-++hbbERL.jpg" },
                    new() { Titulo = "La sombra del viento", Autor = "Carlos Ruiz Zafón", Genero = "Misterio", ISBN = "1234567811", Anio = 2001, Descripcion = "Libros y secretos.", Imagen = "https://proassetspdlcom.cdnstatics2.com/usuaris/libros/fotos/222/original/portada___201609051317.jpg" },
                    ...
                    new() { Titulo = "Cien años de soledad", Autor = "Gabriel García Márquez", Genero = "Ficcion", ISBN = "1234567813", Anio = 1967, Descripcion = "La saga de los Buendía.", Imagen = "https://m.media-amazon.com/images/I/91S1vKWiZWL._AC_UF1000,1000_QL80_.jpg" },
                    new() { Titulo = "Ready Player One", Autor = "Ernest Cline", Genero = "Ciencia ficcion", ISBN = "1234567814", Anio = 2011, Descripcion = "Realidad virtual.", Imagen = "https://images-na.ssl-images-amazon.com/images/I/A1JVqNMI7UL.jpg" },
                    new() { Titulo = "El psicoanalista", Autor = "John Katzenbach", Genero = "Thriller", ISBN = "1234567815", Anio = 2002, Descripcion = "Juego psicológico mortal.", Imagen = "https://m.media-amazon.com/images/I/81uSkoXbBZL._AC_UF1000,1000_QL80_.jpg" },
                    ...
                    new() { Titulo = "El señor de las moscas", Autor = "William Golding", Genero = "Ficcion", ISBN = "1234567818", Anio = 1954, Descripcion = "Supervivencia infantil.", Imagen = "https://m.media-amazon.com/images/I/71PduHC+t2L._AC_UF894,1000_QL80_.jpg" },
                    new() { Titulo = "Los juegos del hambre", Autor = "Suzanne Collins", Genero = "Distopia", ISBN = "1234567819", Anio = 2008, Descripcion = "Lucha por sobrevivir.", Imagen = "https://images-na.ssl-images-amazon.com/images/I/71un2hI4mcL.jpg" }
                };
